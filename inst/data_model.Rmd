...
**Observations:** `r knitr::combine_words( observation.contents)`.

**Dissection:** 


<!-- Automatically add dissection images with height 1000px -->
```{r eval=TRUE, include=TRUE, echo=FALSE, fig.align='center', fig.show='hold', fig.cap= 'Temporary slide in alcohol gel.'}
