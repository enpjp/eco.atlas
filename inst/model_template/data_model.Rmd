...
```{r  eval=TRUE,  include=TRUE, echo=FALSE, fig.align='center', fig.show='hold', fig.cap='{{{index.reference}}} Specimen images'  }
...
datumList <- list(
  "FW.length" = "Forewing length mm",
  "FW.width" = "Forewing width mm",
  "EYE.d" = "Eye diameter mm", 
  "Ocelli" = c("Present. Absent"),
  "Ocelli.position" = c("Anterior, Posterior"),
  "Ocelli.angle" = "Clockwise angle from antennae",
  "Ocelli.placement" = c("Proximal, Distal"),
  "Labial.palps" = c("Upright, Forward, Decending"),
  "Frons" = c("Rough, Smooth"),
  "Vertex" = c("Rough, Smooth"),
  "EYE.texture" = c("Hairy, Hairless"),
  "Chaetosemata" = c("Present, Absent")
)
...
```{r eval=TRUE, include=TRUE, echo=FALSE, fig.align='center', fig.show='hold', fig.cap= '{{{index.reference}}} Temporary slide in Hoyers.'}
